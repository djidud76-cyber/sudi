    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 p-4 text-zinc-900 dark:text-zinc-50">
      <div className="w-full max-w-sm space-y-6 animate-in fade-in zoom-in-95 duration-500">
        <div className="text-center">
          <Link to="/" className="mx-auto w-12 h-12 bg-black dark:bg-white rounded-xl flex items-center justify-center mb-4 cursor-pointer inline-flex hover:scale-105 transition-transform">
            <span className="text-white dark:text-black font-bold text-2xl leading-none tracking-tighter">s</span>
          </Link>
          <h2 className="text-2xl font-bold tracking-tight">Sign in to Sudi</h2>
          <p className="text-zinc-500 dark:text-zinc-400 mt-1 text-sm">Welcome back! Please enter your details.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 rounded-2xl shadow-sm">
        ...
        <p className="text-center text-sm text-zinc-500 dark:text-zinc-400">
          ...
          <Link to="/register" className="text-black dark:text-white font-medium hover:underline">Sign up for free</Link>
        </p>
      </div>
    </div>
  );
